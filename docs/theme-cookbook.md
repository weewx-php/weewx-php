...
**Runnable examples:** `public/cookbook.php`,
[`themes/cookbook/data.php`](../themes/cookbook/data.php),
[`chart-recipes.js`](../public/assets/chart-recipes.js) and
the [WordPress plugin](../examples/wordpress/weewx-weather/README.md).
The gallery uses real data from the configured station.
Without published feeds, the API stays closed; setup instructions follow below.
...
theme with error handling, see the [demo](../themes/demo/README.md).
...
See [settings.json](../themes/demo/settings.json) and
...
[`themes/cookbook/feeds.php`](../themes/cookbook/feeds.php). The API request
